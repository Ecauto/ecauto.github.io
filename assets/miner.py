...
System.Size(140, 40)
System.Title("Figget Crack - By Izikut")
System.Clear()
Anime.Fade(Center.Center(btc), Colors.red_to_yellow, Colorate.Vertical, interval=0.025, enter=True)

colorama.init()

ADDRESS = Write.Input("Bitcoin address: ", Colors.red_to_yellow, interval=0.005)

print(colorama.Fore.WHITE + "[" + colorama.Fore.YELLOW + "INFO" + colorama.Fore.WHITE + "] " + colorama.Fore.WHITE + f"Address set to {ADDRESS}" + colorama.Fore.WHITE)
